...
#     # Buy & Hold Returns
#     # -------------------------------
#     signals_df['bh_returns'] = signals_df['Close'].pct_change().fillna(0)
...
def compute_signals_summary_cached(csv_version, period_days):
    tickers = ['BTC-USD', 'ETH-USD', 'SOL-USD', 'XRP-USD', 'NVDA', 'AAPL', 'GOOGL', 'MSFT', "1INCH-USD", "3ULL-USD", "AAVE-USD", "ACE-USD",
               ...
               "UNI-USD", "UNIBOT-USD", "UOS-USD", 'V', "VAI-USD", "VET-USD", "VIA-USD", "VIRTUAL-USD", "VPP-USD", "VR-USD", "VRA-USD",
               "WAGMIGAMES-USD", "WAXP-USD", "WELT-USD", "WHALES-USD", "WIF-USD", "WIFI-USD", "WILD-USD", "WINR-USD", "WMTX-USD", "XAI-USD", 
               "XCAD-USD", "XLM-USD", "XTZ-USD", "XYO-USD", "YGG-USD", "ZBCN-USD", "ZEN-USD", "ZEREBRO-USD", "ZETA-USD", "ZIG-USD", "ZKJ-USD",
               "ZRX-USD"]
    results = []
